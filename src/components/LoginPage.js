...
export default function LoginPage() {
  ...
  return (
    <>
    <div className="dark">
        <div className="dark:bg-gray-800 min-h-full flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
          <div className="max-w-md w-full space-y-8 dark:bg-gray-800">
            <div className="mx-auto h-12 w-12 justify-items-center">
              <Image
            ...
            <form className="mt-8 space-y-6" onSubmit={submitHandler}>
              ...
              <div>
                ...
                {auth.error  ?
                  <div className="text-left p-4 mb-4 text-sm text-red-700 bg-red-100 rounded-lg dark:bg-red-200 dark:text-red-800" role="alert">
                  {auth.error} &nbsp; &nbsp;
                  <ModalLoginError />
                  </div>
                : null}
